...
//     try {
//       updateAvailability(backendAvailability);
//       setAvailability(updatedAvailability);
...
//     );
//     if (!confirm) {
//       alert("Action cancelled: Weekly schedule update was not applied.");
//       return;
//     }
...
//       setActiveTab("slots");
//       alert(`Weekly schedule updated: Slots added for ${startDate}–${endDate}.`);
//     } catch (err) {
//       alert(`Failed to update weekly schedule: ${err.response?.data?.message || "Please try again."}`);
//     }
//   };
