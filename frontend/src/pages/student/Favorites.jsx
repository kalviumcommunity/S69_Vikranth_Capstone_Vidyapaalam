...
// import { StarIcon, ChatBubbleLeftIcon, HeartIcon, MapPinIcon } from "@heroicons/react/24/solid";
...
//     experience: "5 years",
//     bio: "Certified yoga instructor specializing in Hatha and Vinyasa flows. Passionate about mindfulness and flexibility training, with over 2000 hours taught.",
//   },
//   {
//     id: "2",
//     name: "David Lee",
...
//     experience: "10 years",
//     bio: "Professional guitarist skilled in classical, acoustic, and electric styles. Has performed internationally and recorded three albums.",
//   },
//   {
//     id: "4",
//     name: "Michael Chen",
...
//     experience: "8 years",
//     bio: "Full-stack software engineer proficient in React, Node.js, and Python. Passionate about teaching coding fundamentals and best practices.",
//   },
// ];
...
//     notification.className = "fixed bottom-4 right-4 bg-orange-100 border border-orange-400 text-orange-800 shadow-lg rounded-lg p-4 animate-fade-in z-50";
...
//       >
//         <h2 className="text-3xl sm:text-4xl font-bold text-orange-600 mb-2">Favorite Teachers</h2>
...
//             <motion.div
//               key={teacher.id}
//               className="w-full max-w-2xl mx-auto bg-white rounded-lg border border-gray-100 shadow transition-shadow hover:shadow-lg p-6 flex flex-col md:flex-row items-start gap-6"
...
//                   className="p-2 rounded-md border border-gray-200 hover:bg-orange-100"
//                 >
//                   <HeartIcon className="h-5 w-5 text-red-500" />
//                 </button>
//                 <Link
//                   to={`/student/chat/${teacher.id}`}
//                   className="flex items-center gap-1 px-3 py-2 rounded-md border border-gray-200 text-blue-600 hover:bg-blue-50 text-sm"
//                 >
...
//       <style>
//         {`@keyframes fadeIn { from { opacity: 0; transform: translateY(10px);} to{ opacity: 1; transform: translateY(0);} } @keyframes fadeOut { from { opacity: 1; transform: translateY(0);} to{ opacity: 0; transform: translateY(10px);} } .animate-fade-in{ animation: fadeIn 0.3s ease-out forwards;} .animate-fade-out{animation: fadeOut 0.3s ease-out forwards;}`}
//       </style>
//     </div>
//   );
// };
...
// src/pages/student/Favorites.jsx
