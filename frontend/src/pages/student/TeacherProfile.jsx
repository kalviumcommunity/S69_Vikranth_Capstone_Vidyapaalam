...
const TeacherProfile = () => {
  ...
  return (
    <div className="p-4 md:p-8 w-full min-h-screen bg-white overflow-x-hidden">
      <div className="max-w-5xl mx-auto space-y-6">
        <h1 className="text-3xl font-bold text-gray-800 mb-4">{teacher.name}</h1>

        {/* Teacher Card - Full Width Horizontal */}
