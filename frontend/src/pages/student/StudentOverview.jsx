...
// export default function StudentOverview() {
//   const { upcoming, past, loading, error, fetchSessions } = useSession();
//   const [showPast, setShowPast] = useState(false);

//   // Use user name from AuthContext if available, fallback to "Student"
//   const { user } = useSession(); // Assuming AuthContext is a parent of SessionContext
