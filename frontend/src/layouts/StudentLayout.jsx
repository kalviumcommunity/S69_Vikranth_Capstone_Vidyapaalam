...
//         <div className="flex flex-col items-center px-4 py-6 border-b border-gray-100 flex-shrink-0">
//           <div className="relative flex items-center justify-center h-16 w-16 text-2xl bg-orange-100 text-orange-600 rounded-full font-bold border-2 border-orange-300 shadow-md">
//             {avatarInitials}
//             <span className="absolute bottom-0 right-0 h-3 w-3 bg-green-500 rounded-full border-2 border-white"></span>
//           </div>
//           <motion.div
